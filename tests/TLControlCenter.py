...
class AppTrafficLight():
	...
	def __init__(self):
		...
		Button(self.welcomeScreen,text="INICIO", command= self.gotoMainScreen).place(x=450,y=200)
		Label(self.welcomeScreen,text="LOGOTIPO CLIENTE").place(x=200,y=100)
		Label(self.welcomeScreen,text="NOMBRE CLIENTE").place(x=200,y=150)
		Label(self.welcomeScreen,text="VERSION FIRMWARE CONTROL").place(x=200,y=200);Label(self.welcomeScreen,text=self.VersionNumber.get()).place(x=200,y=225)
		Label(self.welcomeScreen,text="VERSION FIRMWARE PANTALLA").place(x=200,y=250)
